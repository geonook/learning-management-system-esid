-- ========================================
-- Migration 015b: Optimize RLS Policies for Performance (IDEMPOTENT VERSION)
-- Date: 2025-10-28
-- Version: 015b (Fixed version of 015)
...
-- ========================================
--
-- IMPORTANT: This is Migration 015b - The Idempotent Version
-- =========================================================
-- This version fixes the "policy already exists" error from Migration 015
-- by adding DROP POLICY IF EXISTS before all CREATE POLICY statements.
--
-- Changes from Migration 015:
--   1. Added header explaining this is version 015b
--   2. Added DROP IF EXISTS before Part 11 (service_role_bypass) policies
--   3. Added DROP IF EXISTS before Part 12 (authenticated_read) policies
--
-- This migration can be safely re-executed multiple times.
-- ========================================
...
-- 015b CHANGE: Added DROP IF EXISTS before each CREATE POLICY
