      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-surface-secondary rounded-xl border border-border-default p-4">
            ...
            <select className="w-full px-4 py-2 bg-surface-secondary border border-border-default rounded-lg text-text-primary">
          ...
          <div className="bg-surface-secondary rounded-xl border border-border-default p-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1 text-center">
                ...
                <div className="text-xs text-text-tertiary">Class A</div>
              </div>
              <div className="text-border-default">vs</div>
              <div className="flex-1 text-center">
                <div className="text-xl font-bold text-text-primary">-</div>
                <div className="text-xs text-text-tertiary">Class B</div>
              </div>
            </div>
          </div>
          <div className="bg-surface-secondary rounded-xl border border-border-default p-4">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border-default">
                ...
                <th className="text-center p-4 text-sm font-medium text-text-secondary">Class A</th>
                <th className="text-center p-4 text-sm font-medium text-text-secondary">Class B</th>
            ...
            <tbody>
              {["FA1", "FA2", "FA3", "FA4", "SA1", "SA2", "FINAL"].map((assessment) => (
                <tr key={assessment} className="border-b border-border-subtle hover:bg-surface-hover">
                  <td className="p-4 text-text-primary">{assessment}</td>
